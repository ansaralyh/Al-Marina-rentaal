        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
              Get in touch with our team for any inquiries, bookings, or
              support. We're here to help you find the perfect luxury vehicle.
            </p>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                answer:
                  "You can book through our website, call us directly, or visit our showroom. We offer online booking, phone reservations, and in-person consultations.",
              },
              {
                question: "What documents do I need to rent a car?",
                answer:
                  "You'll need a valid driving license, passport or Emirates ID, and a credit card for the security deposit. International visitors need an international driving permit.",
              },
              {
                question: "Do you provide chauffeur services?",
                answer:
                  "Yes, we offer professional chauffeur services for all our luxury vehicles. Our experienced drivers are available for airport transfers, business meetings, and special events.",
              },
              {
                question: "What is your cancellation policy?",
                answer:
                  "We offer flexible cancellation policies. Free cancellation up to 24 hours before pickup. For same-day cancellations, a small fee may apply.",
              },
              {
                question: "Do you offer insurance coverage?",
                answer:
                  "Yes, all our rentals include comprehensive insurance coverage. We also offer additional coverage options for extra peace of mind.",
              },
            ].map((faq, index) => (
